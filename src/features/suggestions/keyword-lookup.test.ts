...
describe("findExactMatch", () => {
  const mappings: KeywordMapping[] = [
    { keyword: "makan", categoryId: "c1", usageCount: 5 }, // 0.95 + 0.05 = 1.0
    { keyword: "bensin", categoryId: "c2", usageCount: 2 }, // 0.95 + 0.02 = 0.97
    { keyword: "listrik", categoryId: "c3", usageCount: 0 }, // 0.95
  ];
  ...
  it("caps confidence at 1.0", () => {
    const highUsage = [{ keyword: "rokok", categoryId: "c4", usageCount: 100 }];
